    ...
    return (
        ...
        >
            ...
            <div className="w-full flex flex-col items-center text-center mb-32">
                ...
                <h1 ref={ourStoryBigHeaderRef} className="font-heading text-6xl text-text max-w-3xl mt-6 leading-tight">
            ...
            {/* CONTENT */}
            <div ref={ourStoryContentRef} className="w-full flex items-center gap-24">

                {/* IMAGE */}
                <div
                    ref={storyImageRef}
                    className="w-[50%] h-[640px] overflow-hidden rounded-2xl"
                >
                    <img
                ...
                <div
                    ref={storyContentRef}
                    className="w-[40%] font-body text-text"
                >
