    ...
    return (
        ...
        >
            ...
            <div className="w-full flex flex-col items-center text-center mb-28">
                ...
                <h1 ref={experienceBigTitle} className="font-heading text-6xl text-text max-w-3xl mt-6 leading-tight">
                    What makes
            ...
            {/* FEATURES */}
            <div ref={experienceFeatures} className="w-full max-w-6xl mx-auto grid grid-cols-2 gap-x-24 gap-y-20">
